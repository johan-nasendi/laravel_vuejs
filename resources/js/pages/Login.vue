<template>
     <div class="flex flex-wrap w-full justify-center items-center py-5">
        <div class="flex flex-wrap max-w-xl">
            ...
            <div class="p-2 w-full mt-4">
                <span class="font-medium text-dark-600">You don't have an account yet?</span><router-link to="/register" class="font-medium text-indigo-600 hover:text-indigo-500"> Register</router-link>
             </div>
