<template>
    <!-- This example requires Tailwind CSS v2.0+ -->
        ...
        <div class="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-40">
            ...
            <div>
                ...
                <div aria-hidden="true" class="pointer-events-none lg:absolute lg:inset-y-0 lg:max-w-7xl lg:mx-auto lg:w-full">
                 ...
                 <router-link class="inline-block text-center bg-indigo-600 border border-transparent rounded-md py-3 px-8 font-medium text-white hover:bg-indigo-700"  to='/register'>Shop Collection</router-link>
                </div>
            </div>
            </div>
        </div>
